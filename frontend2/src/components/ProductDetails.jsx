...
import { Search, ChevronRight, Heart, Check , Plus} from 'lucide-react';
...
const ProductPage = ({ searchQuery }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div key={product.id || 0} className="container px-4 py-8 mx-auto">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="bg-[#f0f7f4] rounded-3xl p-8">
            ...
            <h1 className="mb-4 text-2xl font-semibold leading-tight text-gray-800 lg:text-3xl">
            {product.title || <span className="italic text-gray-600">Unnamed Product</span>}
          </h1>
              ...
              <>
                ...
                {product.prices[0] && (
                  <a
                    ...
                    className="block p-6 transition-colors bg-gray-100 shadow-sm rounded-2xl hover:bg-gray-50 group hover:shadow-md"
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="mb-1 font-medium">{product.prices[0].retailer}</h3>
                        <div className="flex items-center">
                          <span className="font-semibold text-blue-500">
                            Rs. {product.prices[0].price}
                          </span>
                          {product.prices[0].discount && product.prices[0].discount !== '0%' && (
                            <span className="ml-2 px-2 py-0.5 rounded-md bg-green-100 text-green-700 text-xs font-medium">
                ...
                {product.prices.slice(1).map((item) => (
                  <a
